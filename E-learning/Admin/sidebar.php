              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#users"
                      ...
                      <span class="nav-text">Playlist</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="users"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="add-playlist.php">
                                <span class="nav-text">Add Playlist</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="playlist.php">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#authentication"
                      ...
                      <i class="mdi mdi-image-filter-none"></i>
                      <span class="nav-text">Courses</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="authentication"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="add-course.php">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="course-list.php">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="view-profile.php">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="update.php">
