              ...
              <div class="navbar-right ">
                ...
                <div class="search-form">
                  ...
                  <ul class="dropdown-menu dropdown-menu-search">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="dashboard.php">Morbi leo risus</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="dashboard.php">Dapibus ac facilisis in</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="dashboard.php">Porta ac consectetur ac</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="dashboard.php">Vestibulum at eros</a>
                    </li>
